...
class IMP implements MouseListener{
  ...
  private JMenu getFunctions()
  {
     ...
     JMenuItem secondItem = new JMenuItem("rotate 90 clockwise");
     JMenuItem thirdItem = new JMenuItem("Luminosity Grayscale");
     ...
     secondItem.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) { rotate90();}
            });
     thirdItem.addActionListener(new ActionListener() {
         @Override
         public void actionPerformed(ActionEvent e) { grayscaleLum(); }
            });
  ...
  private void rotate90(){
      ...
      for(int yPix=0; yPix<height; yPix++)
          ...
          {
              newPicture[xPix][yPix] = picture[yPix][xPix];
              picture [yPix][xPix] = 0;
          }
...
//          }
  ...
  private void grayscaleLum(){
      //TODO grayscale image using luminosity method

      for(int i=0; i<height; i++)
          for(int j=0; j<width; j++)
          {
              int red, blue, green, singleChan;
              ...
              singleChan = (int) (0.21*red + 0.72*green + 0.07* blue);

              for (int k=0; k < rgbArray.length - 1; k++){
                  rgbArray[k] = singleChan;
              }
              //take three ints for R, G, B and put them back into a single int
              picture[i][j] = getPixels(rgbArray);
          }
  ...
  private void graysclaePlusBlur(){
      //TODO call grayscale method and then blur
  }
