...
# Create a black background for the drawing box for object tracking 
# NOTE: This will ruin the color image for some reason. but it does give the right black window below the two frames
# zeros_img = np.zeros(np.asanyarray(dimFrame.get_data()).shape)
...
try:
    while True:
        ...
        if depth_colormap_dim != color_colormap_dim:
            ...
            # The two lines below screw up the color image-- and I have no idea what is going on
