...
try:
    while True:
        ...
        check_frame = np.asanyarray(aligned_frames.get_data())
        frame_dim = check_frame.shape
        ...
        setup = np.asanyarray(aligned_depth_frame.get_data())
        depth_frame_dim = setup.shape
